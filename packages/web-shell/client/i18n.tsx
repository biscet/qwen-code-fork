...
const EN: Messages = {
  ...
  'agent.color.inherit': 'Inherit',
  'agent.color.auto': 'Automatic',
  'agent.color.automatic': 'Automatically assigned',
  'agent.color.red': 'Red',
  'agent.color.blue': 'Blue',
  'agent.color.green': 'Green',
  'agent.color.yellow': 'Yellow',
  'agent.color.purple': 'Purple',
  'agent.color.orange': 'Orange',
  'agent.color.pink': 'Pink',
  ...
  'agent.overview.instructions':
    'A system prompt defines the workflow, boundaries, and expected result.',
  'agent.builtin.generalPurpose.description':
    'General-purpose subagent for complex research, code search, and multi-step tasks.',
  'agent.builtin.explore.description':
    'Fast read-only subagent for finding files, searching code, and explaining a codebase.',
  'agent.builtin.statuslineSetup.description':
    'Configures the HomeCode status line while preserving valid user settings.',
  'agent.builtin.review.description':
    'Focused participant in a code review launched by the bundled review skill.',
  ...
  'daemon.logs.download': 'Download logs',
  'daemon.logs.saving': 'Saving…',
  'daemon.logs.saved': 'Logs saved',
  'daemon.logs.failed': 'Could not save logs. Try again.',
  ...
  'skilldesc.computerUse':
    'Control local application interfaces with Computer Use',
  'skilldesc.coordinate':
    'Coordinate a small team of agents with bounded responsibilities',
  ...
  'local.auth': 'Open model settings',
  ...
  'mcp.tool.find_declaration.title': 'Find declaration',
  'mcp.tool.find_declaration.description': 'Finds the declaration of a symbol.',
  'mcp.tool.find_implementations.title': 'Find implementations',
  'mcp.tool.find_implementations.description':
    'Finds implementations of the requested symbol.',
  'mcp.tool.find_referencing_symbols.title': 'Find symbol references',
  'mcp.tool.find_referencing_symbols.description':
    'Finds symbols and code that reference the requested symbol.',
  'mcp.tool.find_symbol.title': 'Find symbol',
  'mcp.tool.find_symbol.description':
    'Finds classes, methods, and other code entities by name path.',
  'mcp.tool.get_diagnostics_for_file.title': 'Check file diagnostics',
  'mcp.tool.get_diagnostics_for_file.description':
    'Returns diagnostics for a file grouped by symbol.',
  'mcp.tool.get_symbols_overview.title': 'View file symbols',
  'mcp.tool.get_symbols_overview.description':
    'Shows the classes, functions, methods, and other symbols in a file.',
  'mcp.tool.initial_instructions.title': 'Open Serena instructions',
  'mcp.tool.initial_instructions.description':
    'Returns the essential instructions for working with Serena tools.',
  'mcp.tool.insert_after_symbol.title': 'Insert after symbol',
  'mcp.tool.insert_after_symbol.description':
    'Inserts code after the selected class, method, or function.',
  'mcp.tool.insert_before_symbol.title': 'Insert before symbol',
  'mcp.tool.insert_before_symbol.description':
    'Inserts code before the selected class, method, or function.',
  'mcp.tool.rename_symbol.title': 'Rename symbol',
  'mcp.tool.rename_symbol.description':
    'Renames a symbol and updates its references across the project.',
  'mcp.tool.replace_symbol_body.title': 'Replace symbol body',
  'mcp.tool.replace_symbol_body.description':
    'Replaces the body of the selected class, method, or function.',
  'mcp.tool.safe_delete_symbol.title': 'Safely delete symbol',
  'mcp.tool.safe_delete_symbol.description':
    'Deletes a symbol when it has no references; otherwise returns those references.',
  ...
  'skills.instructions': 'SKILL.md instructions',
  'skills.instructions.loading': 'Loading SKILL.md…',
  'skills.instructions.empty': 'This skill has no Markdown instructions.',
  'skills.instructions.error': 'Failed to load SKILL.md.',
  ...
  'workspacesOverview.expandChats': (v) => `Show chats in ${v?.name ?? ''}`,
  'workspacesOverview.collapseChats': (v) => `Hide chats in ${v?.name ?? ''}`,
  'workspacesOverview.chatCount': (v) => `${v?.count ?? 0} chats`,
  'workspacesOverview.selectAllChats': 'Select all chats',
  'workspacesOverview.selectedChats': (v) => `${v?.count ?? 0} selected`,
  'workspacesOverview.archiveSelected': 'Archive selected',
  'workspacesOverview.deleteSelected': 'Delete selected',
  'workspacesOverview.archiveAll': 'Archive all',
  'workspacesOverview.deleteAll': 'Delete all',
  'workspacesOverview.archiveChat': (v) => `Archive ${v?.name ?? ''}`,
  'workspacesOverview.deleteChat': (v) => `Delete ${v?.name ?? ''}`,
  'workspacesOverview.openChat': (v) => `Open ${v?.name ?? ''}`,
  'workspacesOverview.emptyChats': 'No active chats in this workspace.',
  'workspacesOverview.untrustedChats':
    'Trust this workspace to view its chats.',
  'workspacesOverview.showMoreChats': (v) => `Show ${v?.count ?? 0} more`,
  'workspacesOverview.attentionChat': 'Needs attention',
  'workspacesOverview.runningChat': 'Running',
  'workspacesOverview.actionUnavailable':
    'This action is unavailable while a chat is active.',
  'workspacesOverview.allChatsUnavailable':
    'The complete chat list could not be loaded.',
  'workspacesOverview.loadChatsFailed': 'Failed to load chats',
  'workspacesOverview.archiveFailed': 'Failed to archive chats',
  'workspacesOverview.deleteFailed': 'Failed to delete chats',
  'workspacesOverview.confirmArchiveTitle': (v) =>
    `Archive ${v?.count ?? 0} chats?`,
  'workspacesOverview.confirmArchive': (v) =>
    `${v?.count ?? 0} chats will move to Archive.`,
  'workspacesOverview.confirmDeleteTitle': (v) =>
    `Delete ${v?.count ?? 0} chats?`,
  'workspacesOverview.confirmDelete': (v) =>
    `${v?.count ?? 0} chats and their conversation history will be permanently deleted. This cannot be undone.`,
  ...
  'settings.label.general.outputLanguage': 'Response language',
  'settings.description.general.outputLanguage':
    'Language used by the model. Applies after restarting HomeCode.',
  'settings.option.general.outputLanguage.auto': 'Match your message',
  'settings.option.general.outputLanguage.Russian': 'Russian',
  'settings.option.general.outputLanguage.English': 'English',
  'settings.option.general.outputLanguage.Chinese': 'Chinese',
  'settings.label.agents.maxParallelAgents': 'Parallel subagent limit',
  'settings.description.agents.maxParallelAgents':
    'Maximum background subagents running at once in each Qwen session. Others wait in a queue. Applies after restarting HomeCode.',
  ...
  'settings.vane.apiKey': 'Qwen 27B API key',
  'settings.vane.apiKeyHint':
    'Use the home-server API key to connect Vane to Qwen3.8-27B.',
  'settings.vane.enterKey': 'Enter API key',
  'settings.vane.replaceKey': 'Enter a replacement key',
  'settings.vane.saveKey': 'Save key',
  'settings.vane.savingKey': 'Saving…',
  'settings.vane.keySaved': 'Key saved',
  'settings.vane.keyConfigured': 'Key configured',
  ...
  'settings.models.keySaved': 'Key saved · leave blank to keep',
  'settings.models.keyPlaceholder': 'Paste your API key',
  'settings.models.keyHint':
    'An empty field keeps the saved key. Enter the key again when changing the API address.',
  'settings.models.default': 'Default',
  'settings.models.unchanged': 'Keep current value',
  'settings.models.reasoningHint':
    'Defaults for this model. Thinking and effort can also be changed in the chat model menu.',
  'settings.models.contextWindowSize': 'Context window · tokens',
  'settings.models.maxTokens': 'Maximum response · tokens',
  'settings.models.temperature': 'Temperature',
  'settings.models.topP': 'Top P',
  'settings.models.advanced': 'Additional settings',
  ...
  'settings.models.deferred':
    'Saved. The model will pick up these settings when its runtime is ready.',
  'settings.models.retry': 'Retry',
  'settings.models.access': 'Access',
  'settings.models.context': 'Context',
  'settings.models.keyConfigured': 'Key connected',
  'settings.models.keyMissing': 'No API key',
  'settings.models.edit': 'Configure',
  'settings.models.checkLimits': 'Check remaining quota',
  'settings.models.modelscope.quota':
    'Daily account and model quotas. Alibaba Cloud account verification required.',
  'settings.models.orcarouter.quota':
    'Free API with request rate limits. No fixed daily or weekly quota.',
  'settings.models.unknown': 'Unknown',
  'settings.models.remaining': (v) => `${v?.count ?? 0} remaining`,
  'settings.models.period.day': 'per day',
  'settings.models.period.week': 'per week',
  'settings.models.period.minute': 'per minute',
  'settings.models.resetAt': (v) => `resets ${v?.time ?? ''}`,
  'settings.models.checkedAt': (v) =>
    `Provider data checked ${v?.time ?? ''}. Usage since then is not included.`,
  'settings.models.quotaUnknown': 'Remaining quota has not been checked.',
  'settings.models.checkHint': 'Checking uses one short API request.',
  'settings.models.deleted': 'Model removed.',
  'settings.models.deletePrompt': (v) =>
    `Remove ${v?.name ?? ''} from this model list?`,
  'settings.models.freeServices': 'Fallback free models',
  'settings.models.freeServicesHint':
    'Free APIs for backup use without registration.',
  'settings.models.freeServicesAvailable': 'LLM7 · Codestral and GPT-OSS',
  'settings.models.freeServicesRequestsMinute': 'Requests per minute',
  'settings.models.freeServicesRequestsHour': 'Requests per hour',
  'settings.models.freeServicesTokensDay': 'Tokens per day',
  'settings.models.freeServicesDocs': 'LLM7 access and limits',
...
const ZH: Messages = {
  ...EN,
  'settings.vane.apiKey': 'Qwen 27B API 密钥',
  'settings.vane.apiKeyHint':
    '使用家庭服务器 API 密钥将 Vane 连接到 Qwen3.8-27B。',
  'settings.vane.enterKey': '输入 API 密钥',
  'settings.vane.replaceKey': '输入替换密钥',
  'settings.vane.saveKey': '保存密钥',
  'settings.vane.savingKey': '正在保存…',
  'settings.vane.keySaved': '密钥已保存',
  'settings.vane.keyConfigured': '密钥已配置',
  ...
  'daemon.refresh': '刷新',
  'daemon.logs.download': '下载日志',
  'daemon.logs.saving': '正在保存…',
  'daemon.logs.saved': '日志已保存',
  'daemon.logs.failed': '无法保存日志，请重试。',
  ...
  'skilldesc.computerUse': '通过 Computer Use 控制本地应用界面',
  'skilldesc.coordinate': '协调职责明确的小型智能体团队',
  ...
  'workspacesOverview.expandChats': (v) => `显示 ${v?.name ?? ''} 中的对话`,
  'workspacesOverview.collapseChats': (v) => `隐藏 ${v?.name ?? ''} 中的对话`,
  'workspacesOverview.chatCount': (v) => `${v?.count ?? 0} 个对话`,
  'workspacesOverview.selectAllChats': '选择所有对话',
  'workspacesOverview.selectedChats': (v) => `已选择 ${v?.count ?? 0} 个`,
  'workspacesOverview.archiveSelected': '归档所选项',
  'workspacesOverview.deleteSelected': '删除所选项',
  'workspacesOverview.archiveAll': '全部归档',
  'workspacesOverview.deleteAll': '全部删除',
  'workspacesOverview.archiveChat': (v) => `归档 ${v?.name ?? ''}`,
  'workspacesOverview.deleteChat': (v) => `删除 ${v?.name ?? ''}`,
  'workspacesOverview.openChat': (v) => `打开 ${v?.name ?? ''}`,
  'workspacesOverview.emptyChats': '此工作区中没有活动对话。',
  'workspacesOverview.untrustedChats': '信任此工作区后可查看其对话。',
  'workspacesOverview.showMoreChats': (v) => `再显示 ${v?.count ?? 0} 个`,
  'workspacesOverview.attentionChat': '需要处理',
  'workspacesOverview.runningChat': '运行中',
  'workspacesOverview.actionUnavailable': '对话活动期间无法执行此操作。',
  'workspacesOverview.allChatsUnavailable': '无法加载完整的对话列表。',
  'workspacesOverview.loadChatsFailed': '加载对话失败',
  'workspacesOverview.archiveFailed': '归档对话失败',
  'workspacesOverview.deleteFailed': '删除对话失败',
  'workspacesOverview.confirmArchiveTitle': (v) =>
    `归档 ${v?.count ?? 0} 个对话？`,
  'workspacesOverview.confirmArchive': (v) =>
    `${v?.count ?? 0} 个对话将移至归档。`,
  'workspacesOverview.confirmDeleteTitle': (v) =>
    `删除 ${v?.count ?? 0} 个对话？`,
  'workspacesOverview.confirmDelete': (v) =>
    `${v?.count ?? 0} 个对话及其历史记录将被永久删除，此操作无法撤销。`,
  'splitView.title': '分屏',
  ...
  'settings.label.general.outputLanguage': '回复语言',
  'settings.description.general.outputLanguage':
    '模型回复使用的语言。重启 HomeCode 后生效。',
  'settings.option.general.outputLanguage.auto': '跟随消息语言',
  'settings.option.general.outputLanguage.Russian': '俄语',
  'settings.option.general.outputLanguage.English': '英语',
  'settings.option.general.outputLanguage.Chinese': '中文',
  'settings.label.agents.maxParallelAgents': '并行子代理上限',
  'settings.description.agents.maxParallelAgents':
    '每个 Qwen 会话同时运行的后台子代理数量。其余任务排队等待。重启 HomeCode 后生效。',

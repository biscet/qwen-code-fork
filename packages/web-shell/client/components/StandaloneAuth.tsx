...
const COPY: Record<WebShellLanguage, AuthCopy> = {
  ru: {
    heading: 'Подключение к HomeCode',
    connecting: 'Подключение…',
    starting: 'Служба запускается…',
    unreachable: 'Служба недоступна. Повторное подключение…',
    notReady: 'Служба ещё не готова. Повторное подключение…',
    startFailed: 'Не удалось запустить службу.',
    invalidToken:
      'Токен недействителен или истёк. Введите токен из терминала службы.',
    enterToken: 'Введите токен доступа из терминала службы.',
    policyBlocked:
      'Доступ запрещён политикой Origin или Host. Откройте прямой адрес службы или проверьте параметр --allow-origin.',
    tokenLabel: 'Токен доступа',
    connect: 'Подключиться',
    retry: 'Повторить',
    hint: 'Токен даёт полный доступ к службе. Вводите его только на странице, открытой по адресу или QR-коду из терминала службы.',
  },
  en: {
